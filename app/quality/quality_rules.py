...
def load_quality_rules(config_path: Path = Path("app/config/quality_rules_sismepre.yaml")) -> dict[str, Any]:
    """
    Carga el archivo YAML con reglas de calidad.
    Este archivo concentra las reglas justificadas por diccionario,
    profiling, patrones de nombres y relaciones internas SISMEPRE.
    """
